...
export const teaRecipes: Recipe[] = [
    ...
    {
        id: 'agua-detox-pepino',
        title: 'Água Detox de Pepino e Hortelã',
        description: 'Hidratante, diurética e super refrescante',
        prepTime: '5 minutos + infusão',
        intensity: 1,
        image: findImage('water-cucumber-mint'),
        ingredients: [
            '1 litro de água gelada',
            '1/2 pepino fatiado finamente',
            '10 folhas de hortelã fresca',
            'Suco de 1/2 limão',
        ],
        preparation: [
            'Em uma jarra grande, adicione as fatias de pepino, as folhas de hortelã e o suco de limão.',
            'Despeje a água gelada sobre os ingredientes.',
            'Mexa suavemente e deixe na geladeira por pelo menos 30 minutos para os sabores se fundirem.',
            'Sirva com gelo ao longo do dia.',
        ],
        whyItWorks: 'Uma forma deliciosa de se manter hidratado. O pepino e a hortelã têm propriedades diuréticas e digestivas, ajudando a eliminar toxinas e reduzir o inchaço. É uma bebida com calorias quase nulas.',
    },
    {
        id: 'limonada-termogenica-caiena',
        title: 'Limonada Termogênica com Pimenta Caiena',
        description: 'Acelera o metabolismo com um toque picante',
        prepTime: '5 minutos',
        intensity: 3,
        image: findImage('lemonade-cayenne'),
        ingredients: [
            '300ml de água gelada',
            'Suco de 1 limão espremido na hora',
            '1 pitada de pimenta caiena em pó',
            'Gelo a gosto',
            'Stevia ou outro adoçante natural a gosto (opcional)',
        ],
        preparation: [
            'Em um copo grande, misture a água gelada e o suco de limão.',
            'Adicione a pitada de pimenta caiena e mexa vigorosamente.',
            'Adoce se desejar e adicione bastante gelo.',
            'Beba imediatamente, de preferência pela manhã ou antes do treino.',
        ],
        whyItWorks: 'A capsaicina, presente na pimenta caiena, tem um forte efeito termogênico, que aumenta a temperatura corporal e acelera o metabolismo, promovendo a queima de calorias. O limão adiciona um efeito detox e alcalinizante.',
    },
    {
        id: 'gengibre-limao',
